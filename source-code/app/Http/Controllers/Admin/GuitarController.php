...
class GuitarController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/guitar/account/' . Auth::user()->id)->with('success', 'your guitar was created successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/guitar/' . $guitar->id)->with('success', 'your guitar was updated successfully');
